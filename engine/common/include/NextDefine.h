...
enum PlayerOption {
    ...
    OPTION_INT64_VIDEO_CACHE_TIME  = 2018,
    OPTION_INT64_AUDIO_CACHE_TIME  = 2019,
    OPTION_INT64_VIDEO_CACHE_SIZE  = 2020,
    OPTION_INT64_AUDIO_CACHE_SIZE  = 2021,
    OPTION_INT64_VIDEO_WIDTH       = 2022,
    OPTION_INT64_VIDEO_HEIGHT      = 2023,
    OPTION_INT64_VIDEO_DECODE_RATE = 2024,
    OPTION_INT64_VIDEO_RENDER_RATE = 2025,
